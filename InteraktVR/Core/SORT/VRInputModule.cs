...
public class VRInputModule : BaseInputModule
{
    ...
    private void UpdateControllerData()  //TODO: FIX
    {
    ...
    private void ProcessPress(PointerEventData eventData)
    {
        ...
        {
            // Debug.Log("MyIsButtonPressedThisFrame");
        ...
        {
            // Debug.Log("MyIsButtonReleasedThisFrame");
    ...
    private bool MyIsButtonReleasedThisFrame() //TODO: FIX
    {
        return true;
        // return (m_isButtonPressedChanged && !m_isButtonPressed);
    }

    private bool MyIsButtonPressedThisFrame() //TODO: FIX
    {
        return true;
        // return (m_isButtonPressedChanged && m_isButtonPressed);
    }
